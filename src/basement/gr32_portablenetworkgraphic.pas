...
type
  ...
  PRGB24 = ^TRGB24;
  TRGB24Array = array [0..65535] of TRGB24; // !!!! [0..0]
  ...
  public
    procedure ReadFromStream(Stream: TStream; ChunkSize: Cardinal); override;
    procedure WriteToStream({%H-}Stream: TStream); override;
  ...
  protected
    ...
    procedure AssignTo(Dest: TPersistent); override;
  public
    procedure ReadFromStream(Stream: TStream; {%H-}ChunkSize: Cardinal); override;
    procedure WriteToStream(Stream: TStream); override;
...
function Swap16U(Value: Word): Word;
var
  t: Byte;
begin
  with T16Bit(Value) do
...
function Swap32Cardinal(Value: Cardinal): Cardinal;
var
  Temp: Byte;
begin
  with T32Bit(Value) do
...
begin
  ...
  begin
    ...
    try
      ...
      Read(ChunkCRC, 4);
      {$IFDEF CheckCRC}
      if not CheckCRC(MemoryStream, Swap32Cardinal(ChunkCRC)) then
...
var
  ...
  begin
    ...
    CRC := Swap32Cardinal(CalculateCRC(MemoryStream));
