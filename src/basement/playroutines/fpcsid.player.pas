...
uses
	Classes, SysUtils {$IFDEF USE_BASEMENT}, Basement.Audio{$ENDIF}	;
...
procedure TSIDPlayer.Play;
begin
	{$IFDEF USE_BASEMENT}
	// Enable the audio callback
	Audio.Play;
	{$ENDIF}
end;

procedure TSIDPlayer.Stop;
begin
	{$IFDEF USE_BASEMENT}
...
function TSIDPlayer.Load(const Filename: String; TuneIndex: Byte = 0; SIDChip: Word = 0): Boolean;
var
...
begin
	...
	Audio.RegisterPlayer(Self, 'SID', '*.sid');
